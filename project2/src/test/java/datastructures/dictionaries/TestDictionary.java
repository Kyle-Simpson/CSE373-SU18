...
/**
 * Note: Rather then running this class directly, run either TestArrayDictionary
 * or TestChainedHashDictionary.
 *
...
public abstract class TestDictionary extends BaseTest {
    ...
    public void testNullKey() {
        ...
        assertEquals("valA", dict.get("keyA"));
        assertEquals("valB", dict.get("keyB"));
    ...
    public void testIterator() {
        ...
        for (KVPair<String, Integer> pair : dict) {
            ...
            // System.out.print("remove(in loop): " + key +" ");
            copy.remove(key);
        }
